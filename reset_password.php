...
<body>
    <div class="form-container">
        ...
        <?php if ($showForm): ?>
            <form method="POST" action="reset_password?member_id=<?= htmlspecialchars($_GET['member_id']) ?>&reset_code=<?= htmlspecialchars($_GET['reset_code']) ?>">
        ...
        <?php if (!empty($message)): ?>
            ...
            <?php if (strpos($message, 'error:') === 0): ?>
                <p>
                    <a href="forgot_password">Request a new password reset</a>
                </p>
            <?php endif; ?>
        <?php endif; ?>
    </div>
