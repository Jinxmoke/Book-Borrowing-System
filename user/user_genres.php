...
$genre_categories = [
    'Fiction' => [
        ...
        "Crime fiction", "Dystopian Fiction", "Young Adult", "Romance", "Adventure fiction",
    ...
    'Non-Fiction' => [
        ...
        "Business economics", "Health and Wellness", "Anthology","Humor", "Instruction manuals",
        "True crime", "Crafting",
        "mathematics", "literature", "business", "chemistry", "economics", "history",
        "philosophy", "statistics", "memoir", "travel writing", "narrative nonfiction",
        "science", "journalism", "self-help book", "biography", "essay", "political science",
...
<body>
    <div class="container">
        ...
        <div class="total-books">
            <a class="btn" href="user_catalogForm">All book titles: <?php echo $total_books; ?></a>
        </div>
                ...
                <div class="genres-container">
                    <?php foreach ($genres as $genre): ?>
                        <div class="genre-item">
                            <a href="user_booksGenre?genre=<?php echo urlencode($genre); ?>" class="genre-name">
