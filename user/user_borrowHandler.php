...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($count_row['request_count'] >= 3) {
        header("Location: user_catalogForm?message=You can only have up to 3 pending requests at a time.");
        exit();
    }
    ...
    try {
        ...
        header("Location: user_catalogForm?message=Book request successfully");
        exit();
