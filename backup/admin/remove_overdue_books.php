...
// Query to select overdue books along with the borrower's name, book title, and borrow date
$sql = "
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Insert the overdue book into the returned_books table
        $insert_sql = "
        ...
        // Delete the overdue book from borrowed_books
