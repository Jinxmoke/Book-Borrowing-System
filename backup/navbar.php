...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="nav-links" id="navLinks">
            ...
            <a href="guest/guest_catalog.php" class="navbar-link">Catalog</a>
            <a href="guest/user_genres.php" class="navbar-link">Categories</a>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        searchForm.addEventListener('submit', function(e) {
            ...
            if (searchTerm.trim()) {
                window.location.href = `guest/user_searchBook.php?searchInput=${encodeURIComponent(searchTerm)}`;
            }
        });
