...
<body>
    <div class="container">
        ...
        <div id="empty-state" class="hidden">
            ...
            <a href="user_catalogForm.php" class="button">
                 Browse Books
            </a>
        </div>
    </div>
            ...
            function renderBookmarks(filteredBookmarks) {
                ...
                if (filteredBookmarks.length === 0) {
                    ...
                    filteredBookmarks.forEach(book => {
                        ...
                        card.className = 'card';
                        card.innerHTML = `
                            <div class="card-image" style="background-image: url('../uploads/${book.image}')" onclick="window.location.href='user_descriptionForm.php?book_id=${book.book_id}'"></div>
