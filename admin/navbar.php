...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="logo-container">
            ...
            <a href="homepage" class="logo">Book Borrowing
    ...
    <div class="nav-links" id="navLinks">
      ...
      <div class="dropdown desktop-dropdown">
          ...
          <div class="dropdown-menu">
              <a href="admin_catalogForm" class="dropdown-item">View Catalog</a>
              <a href="admin_condemnedBooks" class="dropdown-item">Condemn Books</a>
          </div>
      </div>

      <!-- Mobile specific links (initially hidden) -->
      <div class="mobile-links" style="display: none;">
          <a href="admin_catalogForm" class="navbar-link mobile-catalog">View Catalog</a><br>
          <a href="admin_condemnedBooks.php" class="navbar-link mobile-condemned">Condemn Books</a>
      </div>
      <!-- Additional navigation links -->
      <a href="admin_borrowedForm" class="navbar-link">Borrowed Books</a>
      <a href="admin_returnedBooksForm" class="navbar-link">Returned Books</a>
      <a href="admin_manageMembersForm" class="navbar-link">Manage Members</a>
      <a href="admin_pendingRequest" class="navbar-link">Book Request</a>
  </div>
        ...
        <div class="nav-icons">
            <div class="search-container">
                ...
                <div class="search-box" id="searchBox">
                  <form id="searchForm" action="ldr_searchBook" method="get" class="search-form">
                      <div class="search-container">
                          <input type="text"
                                 id="searchInput"
                                 name="searchInput"
            ...
            <div class="notification-dropdown" id="notificationDropdown">
                ...
                <div class="notification-footer">
                    <a href="admin_allNotification">View All</a>
                </div>
            </div>
