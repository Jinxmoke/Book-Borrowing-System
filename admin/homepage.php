...
.dashboard-metric-card.total-books { background-color: #93e994; }
...
<script>
    // Function to check and insert overdue notifications
    function checkOverdueNotifications() {
        $.ajax({
            url: 'overdue_notifications.php', // Path to your PHP script
            method: 'POST',
            dataType: 'json',
    ...
    // Set interval to call the function once a day (86400000 milliseconds = 24 hours)
    setInterval(checkOverdueNotifications, 86400000); // 24 hours in milliseconds
</script>
</body>
</html>
