    ...
    <div class="description-container">
            ...
            <div class="description-book-info">
                ...
                <div class="description-action-buttons">
                    <?php if ($book['status'] === 'available'): ?>
                        <form action="user_borrowHandler" method="post" class="borrow-form" data-title="<?= htmlspecialchars($book['title']) ?>">
        ...
        <div class="description-recommended-section">
            <div class="description-recommended-header">
                ...
                <a href="user_booksGenre?genre=<?= urlencode($genre) ?>" class="description-see-all">See all</a>
            </div>
                ...
                <?php else: ?>
                    <?php foreach ($similar_books_array as $similar_book): ?>
                        <div class="description-book-card">
                            <a href="guest_descriptionForm?book_id=<?= htmlspecialchars($similar_book['book_id']) ?>">
                            ...
                            <div class="description-book-card-content">
                                ...
                                <div class="description-book-card-actions">
                                    ...
                                    <?php if ($similar_book['status'] === 'available'): ?>
                                        <form action="user_borrowHandler" method="post" class="borrow-form" data-title="<?= htmlspecialchars($similar_book['title']) ?>">
